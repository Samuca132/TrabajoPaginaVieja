...
<body>
    ...
    <section class="section-extra-publi">
        <div class="public text-center">
            <a href="https://ayudaenlasemociones.com/campana" target="_blank" style="width:100%;height:100%;"></a>
        </div>
    </section>
    <!--  -->
    <section class="section-bitacora">
        <div class="content">
            <div class="videos">
                <h6 class="title">Como en el consultorio</h6>
                <div class="black-divider"></div>
                <div class="CEEConsultorio">
                   <?php foreach($videos_cuarentena as $video) : ?>
                        <div class="video">
                            <iframe src="<?php echo $video['src'] ?>" height="300" width="486" allowfullscreen frameborder="0"></iframe>
